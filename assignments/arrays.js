...
let lastcarTMP = inventory[inventory.length-1];
let lastcar = [];
lastcar.push(lastcarTMP.car_make);
lastcar.push(lastcarTMP.car_model);
...
newBMWAndAudi = JSON.stringify(BMWAndAudi);
console.log(newBMWAndAudi);
